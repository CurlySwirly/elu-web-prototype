...
/** Shared page chrome for authenticated app views (matches ExpertDashboard). */
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
      <div className="min-w-0 space-y-1">
        <h1 className="font-heading text-xl sm:text-2xl font-bold text-text-dark leading-tight">
          {title}
        </h1>
        {description ? (
